...
const MilestoneTimeline: React.FC<MilestoneTimelineProps> = ({ milestones }) => {
  ...
  // Group by year
  const groupedByYear: { [key: string]: Milestone[] } = {};
              ...
              <div key={year} className="relative">
                ...
                <div className="space-y-4">
                  {groupedByYear[year].map((milestone, index) => (
                    ...
                    >
                      {/* Timeline Dot */}
                      <div className="absolute left-4 md:left-1/2 transform -translate-x-1/2 w-4 h-4 bg-white border-4 border-red-600 rounded-full z-10"></div>
